...
echo ""
echo "  How do you want to start in Claude?"
echo ""
echo "  1) Claude Code (terminal):"
echo "       claude \"set up my chief of staff\""
echo ""
echo "  2) Cowork / claude.ai / Desktop — copy and paste:"
echo ""
echo "  ┌────────────────────────────────────────┐"
echo "  │  set up my chief of staff              │"
echo "  └────────────────────────────────────────┘"
echo ""
echo "  Use it in Cowork or claude.ai too?  Upload the skill once via"
echo "  Customize → Skills → + → Upload a skill (see references/publishing.md)."
echo ""
