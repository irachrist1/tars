...
**Handing off across surfaces.** The user may work in Cowork or claude.ai, where a skill can't be installed. Never assume Claude Code. At the end of setup — and whenever they name another surface — offer both a launch path and a copy/paste path, and pick the prompt by state (`set up my chief of staff` vs `continue as my chief of staff`). See `references/handoff.md`; the paste-ready wrap is `npx tars-chief-of-staff --use`.
